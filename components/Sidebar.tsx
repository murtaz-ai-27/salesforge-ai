...
const NAV = [
  { id:"dashboard", label:"Dashboard", badge:null, icon:"M3 13l2-2 7-7 7 7M5 11v9a1 1 0 001 1h3V15h4v5h3a1 1 0 001-1v-9" },
  { id:"prospects", label:"Prospects", badge:"1.2K", icon:"M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" },
  { id:"sequences", label:"Sequences", badge:"3", icon:"M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" },
  { id:"agents", label:"AI Agents", badge:"10", icon:"M13 10V3L4 14h7v7l9-11h-7z" },
  { id:"automations", label:"Automations", badge:"15", icon:"M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" },
  { id:"inbox", label:"Inbox", badge:"12", icon:"M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" },
  { id:"analytics", label:"Analytics", badge:null, icon:"M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
];
...
export default function Sidebar({ active, user, onLogout }: { active:string; user:User|null; onLogout:()=>void }) {
  ...
  return (
    <div style={{ position:"fixed",left:0,top:0,bottom:0,width:240,background:S.bg,borderRight:`1px solid ${S.border}`,display:"flex",flexDirection:"column",zIndex:100 }}>
      {/* Logo */}
      ...
      <nav style={{ flex:1,padding:"12px 10px",overflowY:"auto" }}>
        ...
        {NAV.map(item => {
          ...
          return (
            <button key={item.id} onClick={() => router.push(`/dashboard${item.id==="dashboard"?"":"/"+item.id}`)}
              style={{ width:"100%",display:"flex",alignItems:"center",gap:10,padding:"10px 12px",borderRadius:10,marginBottom:2,border:"none",cursor:"pointer",fontFamily:"Inter,sans-serif",transition:"all 0.15s",
              ...
              {isActive && <div style={{ width:3,height:16,borderRadius:2,background:S.accent,position:"absolute",right:0 }}/>}
            </button>
          );
        })}
      </nav>

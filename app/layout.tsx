...
export const metadata: Metadata = {
  title: { default:"Salevrix AI — AI-Powered Sales Platform", template:"%s | Salevrix AI" },
  description:"Replace Apollo.io with Salevrix AI. 10 AI agents, 15 automations, 100% data accuracy. Start free — no credit card required.",
  ...
  openGraph:{
    ...
    title:"Salevrix AI — The Apollo.io Alternative That Actually Works",
    description:"10 AI agents. 15 automations. 100% data accuracy. Replace Apollo.io and 3x your reply rates. Start free.",
    images:[{ url:"/og-image.png", width:1200, height:630, alt:"Salevrix AI" }],
  },
  twitter:{
    card:"summary_large_image",
    title:"Salevrix AI — Replace Apollo.io",

...
const EXTRA_AGENTS = [
  { id:"e1",type:"cold_caller",status:"active",meetings_booked:0,emails_sent:0,replies_handled:28,color:"#f59e0b",bg:"rgba(245,158,11,0.08)",icon:"M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z",name:"Cold Call Script Writer",tagline:"Opens doors with the perfect first 30 seconds",description:"Writes complete cold call scripts tailored to your prospect. Opening hook, value prop, qualifying questions, objection handlers, and close.",capabilities:["Personalized 8-second opener","Industry-specific value prop","4 objection handlers","Qualifying discovery questions","Two-option meeting close"],limitation:"Scripts need tone adjustment for your style" },
  { id:"e2",type:"linkedin_writer",status:"active",meetings_booked:0,emails_sent:0,replies_handled:45,color:"#60a5fa",bg:"rgba(96,165,250,0.08)",icon:"M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z M4 6a2 2 0 100-4 2 2 0 000 4z",name:"LinkedIn Writer",tagline:"LinkedIn messages that actually get replies",description:"Write hyper-personalized LinkedIn connection requests and follow-up messages referencing prospect's recent posts, achievements, or company milestones. 45%+ acceptance rates.",capabilities:["Connection request writing","Follow-up message sequences","Post engagement hooks","InMail copy","Profile-based personalization"],limitation:"Works best with LinkedIn profile URL provided" },
  { id:"e3",type:"proposal_writer",status:"active",meetings_booked:0,emails_sent:0,replies_handled:12,color:"#34d399",bg:"rgba(52,211,153,0.08)",icon:"M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z",name:"Proposal Writer",tagline:"Win-ready proposals in minutes",description:"Turn discovery call notes into polished, client-ready proposals with executive summary, solution overview, pricing, timeline, and ROI projection.",capabilities:["Executive summary writing","Solution positioning","Pricing page copy","ROI projection framing","Timeline creation"],limitation:"Requires discovery call notes as input" },
  { id:"e4",type:"revenue_forecaster",status:"active",meetings_booked:0,emails_sent:0,replies_handled:0,color:"#f472b6",bg:"rgba(244,114,182,0.08)",icon:"M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",name:"Revenue Forecaster",tagline:"CFO-ready forecasts from your pipeline",description:"Input pipeline stages, deal sizes, and close probabilities — get realistic revenue forecasts with best/worst/likely scenarios for data-driven decisions.",capabilities:["Pipeline revenue modeling","Best/worst/likely scenarios","Close probability weighting","Monthly/quarterly projections","Deal risk flagging"],limitation:"Accuracy depends on pipeline data quality" },
  { id:"e5",type:"competitor_intel",status:"active",meetings_booked:0,emails_sent:0,replies_handled:8,color:"#a78bfa",bg:"rgba(167,139,250,0.08)",icon:"M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18",name:"Competitor Intel",tagline:"Know your enemy before every call",description:"Research any competitor and get a battle card with their weaknesses, your win angles, common objections, and killer questions that expose their limitations.",capabilities:["Competitor weakness mapping","Win angle identification","Battle card generation","Objection pre-emption","Killer discovery questions"],limitation:"Based on publicly available information" },
  { id:"e6",type:"sdr",status:"active",meetings_booked:14,emails_sent:127,replies_handled:34,color:"#C8FF00",bg:"rgba(200,255,0,0.08)",icon:"M13 10V3L4 14h7v7l9-11h-7z",name:"SDR Agent Alpha",tagline:"Books meetings while you sleep",description:"Your autonomous SDR that writes hyper-personalized cold emails referencing LinkedIn activity, company news, or recent funding. Sounds like your best rep.",capabilities:["Hyper-personalized cold emails","LinkedIn activity references","Company news hooks","Proof points with data","3-touch follow-up sequences"],limitation:"Requires prospect LinkedIn URL for best results" },
  { id:"e7",type:"email_coach",status:"active",meetings_booked:0,emails_sent:89,replies_handled:21,color:"#818cf8",bg:"rgba(129,140,248,0.08)",icon:"M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z",name:"Email Coach",tagline:"Turn good emails into great ones",description:"Paste any email draft and get a rewrite that's shorter, punchier, more personalized, and built around one clear CTA. Coaches you on what was wrong.",capabilities:["Email rewrite & scoring","Subject line optimization","CTA clarity coaching","Spam trigger detection","A/B variant generation"],limitation:"Works best with emails under 200 words" },
  { id:"e8",type:"deal_analyzer",status:"active",meetings_booked:0,emails_sent:0,replies_handled:19,color:"#f59e0b",bg:"rgba(245,158,11,0.08)",icon:"M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",name:"Deal Analyzer",tagline:"Spot dying deals before it's too late",description:"Paste deal notes and get an honest health score, risk flags, missing information gaps, and recommended next actions. Stop surprises at quarter end.",capabilities:["Deal health scoring","Risk flag identification","Missing info gaps","Next action recommendations","Win probability estimate"],limitation:"Needs at least 3 touchpoints of data" },
  { id:"e9",type:"objection_handler",status:"active",meetings_booked:0,emails_sent:0,replies_handled:67,color:"#ef4444",bg:"rgba(239,68,68,0.08)",icon:"M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636",name:"Objection Handler",tagline:"Turn NO into not yet",description:"Paste any objection and get 3 battle-tested response frameworks — reframe, proof, and redirect. Stop losing winnable deals to objections you weren't ready for.",capabilities:["3-framework objection response","Objection pattern recognition","Proof point suggestions","Reframe techniques","Follow-up sequence triggers"],limitation:"Responses need personalization before sending" },
  { id:"e10",type:"meeting_summarizer",status:"active",meetings_booked:0,emails_sent:0,replies_handled:31,color:"#a78bfa",bg:"rgba(167,139,250,0.08)",icon:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",name:"Meeting Summarizer",tagline:"Never miss a follow-up again",description:"Paste raw meeting notes or transcript and get structured summary with key decisions, action items, next steps, and follow-up email draft — in seconds.",capabilities:["Meeting transcript analysis","Key decision extraction","Action item list","Follow-up email draft","Next steps clarity"],limitation:"Accuracy depends on note quality" },
];
...
export default function AgentsPage() {
  ...
  const allAgents = extraAgents; // All 10 agents always shown
  ...
  if (authLoading || dataLoading) return <LoadingScreen text="Activating AI agents"/>;

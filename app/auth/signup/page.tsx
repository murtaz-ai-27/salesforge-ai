  ...
  return (
    <div style={{
      ...
      <div style={{ position: "fixed", inset: 0, zIndex: 0, pointerEvents: "none",
        background: "radial-gradient(60% 50% at 50% -10%, rgba(200,255,0,0.12), transparent 70%), radial-gradient(40% 40% at 15% 90%, rgba(124,58,237,0.1), transparent 70%)" }} />
      <div style={{ position: "fixed", inset: 0, zIndex: 0, pointerEvents: "none",
      ...
      <div style={{ position: "relative", zIndex: 10, width: "100%", maxWidth: 480, padding: "0 24px" }}>
        {/* Logo */}
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <a href="/" style={{ display: "inline-flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
            <span style={{ width: 36, height: 36, borderRadius: 10, background: "#C8FF00",
              display: "grid", placeItems: "center", boxShadow: "0 0 24px rgba(200,255,0,0.35)" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: 24, marginBottom: 28 }}>
          {[["12K+", "Sales teams"], ["3.8x", "More meetings"], ["94%", "Deliverability"]].map(([n, l]) => (
            <div key={l} style={{ textAlign: "center" }}>
              ...
              <div style={{ fontSize: 11, color: "#555a66" }}>{l}</div>
            </div>
          ))}
        </div>

        {/* Box */}
        <div style={{ background: "rgba(13,16,24,0.9)", border: "1px solid rgba(255,255,255,0.07)",
          ...
          <h1 style={{ fontFamily: "Syne, sans-serif", fontSize: 26, fontWeight: 800,
            color: "#f4f5f7", marginBottom: 6, letterSpacing: "-0.03em", textAlign: "center" }}>
            Start closing more deals
          </h1>
          <p style={{ color: "#9598a3", fontSize: 14, textAlign: "center", marginBottom: 28 }}>
            Free 14-day trial · No credit card required
          </p>

          {error && (
            <div style={{ background: "rgba(239,68,68,0.1)", border: "1px solid rgba(239,68,68,0.2)",
              borderRadius: 10, padding: "12px 16px", marginBottom: 20, fontSize: 13, color: "#f87171" }}>
              ⚠️ {error}
            </div>
          )}
          ...
          <button onClick={() => handleAuth("google")} disabled={!!loading}
            style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center",
              ...
              border: "1px solid rgba(200,255,0,0.25)", background: "rgba(200,255,0,0.05)",
              color: "#f4f5f7", fontSize: 15, fontWeight: 600, cursor: loading ? "not-allowed" : "pointer",
              transition: "all 0.2s", marginBottom: 12, fontFamily: "Inter, sans-serif" }}
            ...
            {loading === "google" ? (
              <span style={{ width: 20, height: 20, border: "2px solid rgba(255,255,255,0.3)",
                borderTopColor: "#C8FF00", borderRadius: "50%", animation: "spin 0.8s linear infinite", display: "inline-block" }} />
            ) : (
          ...
          <button onClick={() => handleAuth("github")} disabled={!!loading}
            style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center",
              ...
              color: "#f4f5f7", fontSize: 15, fontWeight: 600, cursor: loading ? "not-allowed" : "pointer",
              transition: "all 0.2s", marginBottom: 24, fontFamily: "Inter, sans-serif" }}
            ...
            {loading === "github" ? (
              ...
              <svg width="20" height="20" viewBox="0 0 24 24" fill="#f4f5f7">
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: 20, marginBottom: 20 }}>
            {["200M+ verified prospects database", "AI SDR Agent books meetings 24/7", "Multi-channel sequences (Email + LinkedIn)", "Real-time intent signals & scoring"].map(f => (
              <div key={f} style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                <span style={{ width: 18, height: 18, borderRadius: "50%", background: "rgba(200,255,0,0.1)",
                  border: "1px solid rgba(200,255,0,0.3)", display: "grid", placeItems: "center", flexShrink: 0 }}>
                  <svg width="10" height="10" viewBox="0 0 12 12" fill="none">
                    <path d="M2 6l3 3 5-5" stroke="#C8FF00" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </span>
        ...
        <p style={{ textAlign: "center", color: "#555a66", fontSize: 12, marginTop: 20 }}>
          By signing up, you agree to our{" "}
          <a href="#" style={{ color: "#9598a3" }}>Terms</a> &amp;{" "}
          <a href="#" style={{ color: "#9598a3" }}>Privacy Policy</a>
        </p>
      </div>

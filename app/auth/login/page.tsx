...
export default function LoginPage() {
  ...
  return (
    <div style={{
      ...
      {/* BG */}
      <div style={{ position:"fixed",inset:0,pointerEvents:"none",background:"radial-gradient(60% 50% at 50% -10%,rgba(200,255,0,0.12),transparent 70%),radial-gradient(40% 40% at 85% 8%,rgba(124,58,237,0.1),transparent 70%)" }}/>
      ...
      <div style={{ position:"relative",zIndex:10,width:"100%",maxWidth:440,padding:"0 24px" }}>
        ...
        <div style={{ background:"rgba(13,16,24,0.95)",border:"1px solid rgba(255,255,255,0.07)",borderRadius:20,padding:"36px 32px",backdropFilter:"blur(20px)",boxShadow:"0 24px 80px rgba(0,0,0,0.5)" }}>
          <h1 style={{ fontFamily:"Syne,sans-serif",fontSize:24,fontWeight:800,color:"#f4f5f7",marginBottom:6,letterSpacing:"-0.03em",textAlign:"center" }}>Welcome back</h1>
          <p style={{ color:"#9598a3",fontSize:14,textAlign:"center",marginBottom:28 }}>Sign in to your SalesForge AI account</p>
          ...
          <button onClick={() => handleAuth("google")} disabled={!!loading}
            style={{ width:"100%",display:"flex",alignItems:"center",justifyContent:"center",gap:12,padding:"14px 20px",borderRadius:12,border:"1px solid rgba(255,255,255,0.1)",background:"rgba(255,255,255,0.04)",color:"#f4f5f7",fontSize:15,fontWeight:600,cursor:loading?"not-allowed":"pointer",transition:"all 0.2s",marginBottom:12,fontFamily:"Inter,sans-serif" }}
          ...
          <div style={{ textAlign:"center",borderTop:"1px solid rgba(255,255,255,0.06)",paddingTop:18 }}>
            <span style={{ color:"#555a66",fontSize:14 }}>Don&apos;t have an account? </span>
            <a href="/auth/signup" style={{ color:"#C8FF00",fontSize:14,fontWeight:600,textDecoration:"none" }}>Sign up free</a>
          </div>
        </div>

        <p style={{ textAlign:"center",color:"#555a66",fontSize:12,marginTop:18 }}>
          By signing in you agree to our <a href="#" style={{ color:"#9598a3" }}>Terms</a> &amp; <a href="#" style={{ color:"#9598a3" }}>Privacy</a>
        </p>
      </div>
